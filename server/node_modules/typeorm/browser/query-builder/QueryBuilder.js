    ...
    QueryBuilder.prototype.replacePropertyNames = function (statement) {
        ...
        var _loop_1 = function (alias) {
            ...
            try {
                ...
                for (var _g = (e_2 = void 0, __values(alias.metadata.relations)), _h = _g.next(); !_h.done; _h = _g.next()) {
            ...
            try {
                for (var _j = (e_3 = void 0, __values(alias.metadata.relations)), _k = _j.next(); !_k.done; _k = _j.next()) {
                    var relation = _k.value;
                    try {
                        for (var _l = (e_4 = void 0, __values(__spread(relation.joinColumns, relation.inverseJoinColumns))), _m = _l.next(); !_m.done; _m = _l.next()) {
            ...
            try {
                for (var _o = (e_5 = void 0, __values(alias.metadata.columns)), _p = _o.next(); !_p.done; _p = _o.next()) {
                    var column = _p.value;
            ...
            try {
                for (var _q = (e_6 = void 0, __values(alias.metadata.columns)), _r = _q.next(); !_r.done; _r = _q.next()) {
                    var column = _r.value;
            ...
            try {
                for (var _s = (e_7 = void 0, __values(alias.metadata.columns)), _t = _s.next(); !_t.done; _t = _s.next()) {
                    var column = _t.value;
