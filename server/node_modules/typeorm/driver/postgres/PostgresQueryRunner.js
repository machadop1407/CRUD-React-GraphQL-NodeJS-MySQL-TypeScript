                                    ...
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, Promise.all(dbColumns
                                                    ...
                                                    var columnConstraints, tableColumn, type, sql, results, geometryColumnSql, results, geographyColumnSql, results, length, match, uniqueConstraint, isConstraintComposite;
                                                    var _this = this;
                                                    return tslib_1.__generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0:
